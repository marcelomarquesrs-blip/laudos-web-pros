...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Safetech Engenharia — Laudos, Inspeções e Projetos Técnicos | RJ" },
      { name: "description", content: "Engenharia especializada em laudos e inspeções NR-13, NR-12, NR-10, SPDA, PPCI, Plano de Rigging, projetos estruturais e sistemas de gás no Rio de Janeiro." },
      { name: "author", content: "Safetech Engenharia" },
      { property: "og:site_name", content: "Safetech Engenharia" },
      { property: "og:title", content: "Safetech Engenharia — Laudos e Inspeções Técnicas" },
      { property: "og:description", content: "Laudos NR-13, NR-12, NR-10, SPDA, PPCI, Rigging, projetos estruturais e sistemas de gás." },
